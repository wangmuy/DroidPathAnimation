...
public class PathPoint {
    ...
    float mX, mY;
    /** Direction in degrees along the path */
    float mBearing=0;
    public float getX() {
        return mX;
    }
    ...
    /**
     * The motion described by the path to get from the previous PathPoint in an PathSentinel
    ...
    public String toString() {
        return "[" + (mOperation==MOVE?"MOVE":(mOperation==LINE?"LINE":"CURVE")) + "(" + mX + ", " + mY + ")]";
    }
}
